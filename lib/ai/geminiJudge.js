...
1. vegetarian（蛋奶素）：是否適合蛋奶素食者
   - false：含肉類（豬、牛、雞、羊等）、海鮮（魚、蝦、蟹、貝類、干貝、扇貝等）、動物油脂、明膠、葷食調味料（如沙茶、肉鬆、魚露）
   - true：植物來源、礦物質、蛋、奶製品

2. vegan（純素）：是否適合純素食者
   - false：含任何動物來源（包括蛋、奶、蜂蜜、動物性成分）
   - true：完全植物來源或礦物質

3. risk（風險等級）：
   - "low"：明確的植物來源（如玉米、小麥、大豆油、砂糖、芝麻、香料等）或礦物質（如鹽）
   - "medium"：可能有動物來源或需確認製程（如乳化劑、調味料）
   - "high"：通常含動物成分（如奶精、起司粉）或明確動物來源

4. reason：簡短說明判斷理由（15字以內）

重要原則：
- **常見植物性食材**（玉米、地瓜粉、花椒、大茴香、砂糖、芝麻、香料等）→ vegetarian=true, vegan=true, risk="low"
- **明確動物性食材**（肉鬆、沙茶、魚露、魚類、扇貝、干貝、蝦、蟹等）→ vegetarian=false, vegan=false, risk="high"
- 含乳製品（奶精、起司）→ vegetarian=true, vegan=false, risk="high"
- 來源不明的添加物（部分乳化劑、調味料）→ risk="medium"
